// export function initJquery()  {/*! jQuery v3.7.0 | (c) OpenJS Foundation and other contributors | jquery.org/license 
    !function (e, t) {
        "use strict";
        ...
        var oe = [], r = Object.getPrototypeOf, ae = oe.slice, g = oe.flat ? function (e) {
            ...
            }, s = oe.push, se = oe.indexOf, n = {}, i = n.toString, ue = n.hasOwnProperty, o = ue.toString,
            a = o.call(Object), le = {}, v = function (e) {
        ...
        !function () {
            var e, b, w, o, a, T, r, C, d, i, k = me, S = ce.expando, E = 0, n = 0, s = W(), c = W(), u = W(), h = W(),
                ...
                m = new RegExp("^" + ge + "*([>+~]|" + ge + ")" + ge + "*"), x = new RegExp(ge + "|>"),
                j = new RegExp(g), A = new RegExp("^" + t + "$"), D = {
                    ID: new RegExp("^#(" + t + ")"),
                    CLASS: new RegExp("^\\.(" + t + ")"),
                    TAG: new RegExp("^(" + t + "|[*])"),
                    ATTR: new RegExp("^" + p),
                ...
                }, N = /^(?:input|select|textarea|button)$/i, q = /^h\d$/i, L = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
        ...
        ce.Callbacks = function (r) {
            ...
            Deferred: function (e) {
                ...
                var n = arguments.length, t = n, r = Array(t), i = ae.call(arguments), o = ce.Deferred(),
                    a = function (t) {
                        return function (e) {
        ...
        ce.event = {
            ...
            ce.event.special[r] = {
                ...
                setup: function () {
                    ...
                    var e = this.ownerDocument || this.document || this, t = C.documentMode ? this : e,
                        n = _.get(t, i) - 1;
